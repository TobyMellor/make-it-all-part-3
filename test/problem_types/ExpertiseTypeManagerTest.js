...
describe('ExpertiseTypeManager', function() {
	...
	describe('getExpertiseTypeChain()', function() {
		it('should return Array', function() {
			assert.typeOf(expertiseTypeManager.getExpertiseTypeChain(expertiseTypeManager.expertiseType), 'Array');//not sure
		});
		
		it('should return correct amount of expertise types in chain', function() {
			assert.lengthOf(expertiseTypeManager.getExpertiseTypeChain(expertiseTypeManager.expertiseType), 1);//not sure
		});
	});
